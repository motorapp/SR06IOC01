...
export motorpath=`grep "MOTOR" configure/RELEASE | cut -d'=' -f2`
export sscanpath=`grep "SSCAN" configure/RELEASE | cut -d'=' -f2`
export galilpath=`grep "GALIL" configure/RELEASE | cut -d'=' -f2`
